...
urlpatterns = [
    ...
    path('register/', apiview.Register.as_view(), name="api-register"),
    path('itemlist/', apiview.ItemListView.as_view(), name="api-list"),
    path('itemdetail/<int:item_id>/', apiview.ItemDetailView.as_view(), name="api-detail"),
